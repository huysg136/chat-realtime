...
import { checkProUser } from "../lib/checkPro";
import { checkMaxUser } from "../lib/checkMax";
import { checkLiteUser } from "../lib/checkLite";
  ...
  return (
    <span style={wrapperStyle}>
      ...
      <span style={{ display: "inline-flex", alignItems: "center", gap: "3px" }}>
        {isAdminOrMod && (
          <MdVerified size={size} style={{ color: "#1877F2" }} />
        )}
      </span>
    </span>
  );
