...
export default function FriendButton({ targetUid, size = "small" }) {
  ...
  if (status === "pending_received") {
    return (
      <div className="fb-row">
        <Button size={size} className="fb-accept" loading={loading} onClick={handleAccept}>
          {t("friends.accept")}
        </Button>
        <Button size={size} className="fb-reject" loading={loading} onClick={handleReject}>
          {t("friends.reject")}
        </Button>
      </div>
    );
  ...
  if (status === "friends") {
    return (
      ...
      >
        <Button size={size} className="fb-friends" loading={loading}>
